...
**Trends**: Calculate monthly intake averages for 2015 to predict resource needs.

**Performance**: Measure the ratio of intakes vs. adoptions.

**Demographics**: Provide a full distribution of animal types and adoption rates by breed/color.

📊 Key Findings

Animal Types: Per Analysis Dogs and Cats are the most animal type found in the Shelter
